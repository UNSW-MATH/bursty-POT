...
family of distributions, an appropriate way to choose between a model with exponential and Mittag-Leffler inter-exceedance times seems to be a Likelihood ratio test. Although the two models are nested, the assymptotic distribution seems no to be chi-squared since under $H_0$ the paremter $\beta$ of Mittag-Leffler distribution is equal to zreo which is on the boundary of the parameter space $(0,1]$. 
<!-- Anpassen:
