...
flare_mags <- actuar::rpareto(n = 500, shape = 0.8, scale = 1)
...
In XX we plotted a Hill plot for differet k's where ..... 

```{r pressure, echo=FALSE, fig.cap="MSE for sample sizes n=30, 100, 200 for the tail and scale estimations via log-moments and maximum likelihood estimation", out.width = '100%'}
knitr::include_graphics("MSE_n25_100_200.pdf")
```
<!-- The QQ-estimator [@Kratz96] is closely related to  -->
