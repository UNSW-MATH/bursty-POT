...
```{r thresholdedBursty, message=FALSE, fig.height=4, fig.width=6, fig.cap="\\label{fig:thresholdedBursty}Exceedances (red) and Times until Exceedance (durations between blue crosses) for a given threshold $\\ell$ (dashed line)."}
